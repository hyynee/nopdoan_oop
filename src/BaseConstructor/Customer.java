...
public class Customer extends Person {
    ...
    public void addCustomerID() {
        ...
        if (listCustomer.countCustomer() < 9) {
            setCustomerld("KH0" + (listCustomer.countCustomer() + 1));
        } else {
            setCustomerld("KH" + (listCustomer.countCustomer() + 1));
        }
    }
    ...
    public String toString() {
        return String.format("| %-10s %-20s %-30s %-10s %-25s %-15s |",
                getCustomerld(), super.getName(), super.getAddress(), super.getAge(), super.getPhone(),
                getTypeCustomer());
    }
    ...
    public String mergeInformationToFile() {
        return String.format("%s;%s;%s;%s;%s;%s", getCustomerld(), super.getName(), super.getAddress(), super.getAge(),
                super.getPhone(), getTypeCustomer());
    }
}
