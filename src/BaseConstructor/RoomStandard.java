...
public class RoomStandard extends Room {
    ...
    public void addRoomStandardID() {
        ListRoomStandard listRoomStandard = new ListRoomStandard();
        if (listRoomStandard.countRoomStandard() < 9) {
            setRoomStandardId("RS00" + (listRoomStandard.countRoomStandard() + 1));
        } else if (listRoomStandard.countRoomStandard() < 99 && listRoomStandard.countRoomStandard() >= 9) {
            setRoomStandardId("RS0" + (listRoomStandard.countRoomStandard() + 1));
        } else {
            setRoomStandardId("RS" + (listRoomStandard.countRoomStandard() + 1));
        }
    }
    ...
    public void output() {
        System.out.printf("\n| %-20s %-25s %-50s %-28s %-28s %-28s %-28s |",
                getRoomStandardId(), roomDetails.getName(), roomDetails.getRoomDetails(), getPricePerHour(),
                getPricePerNight(), getPricePerDay(), roomDetails.getStatus());
    }
